...
import { eagerCMSImageLoader } from '../util';
...
const PostCard = ({ post }) => (
  <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
      <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8 items-centre">
        <Image
          unoptimized
          loader={eagerCMSImageLoader}
